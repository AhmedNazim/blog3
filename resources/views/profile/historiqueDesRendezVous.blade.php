                        ...
                        <form action="">
                           ...
                           <div class="col-lg-5">
                                  ...
                                  <thead>
                                      ...
                                      <tr>
                                        {{-- <th> <b>Matricule</b> </th> --}}
                                        <th width="20%" >Nom patient </th>
                                        <th width="20%">Prénom patient</th>
                                        <th width="20%">Etat de la visite</th>
                                        <th width="20%"> <div align=""> Date de rendez-vous</div></th>
                                      </tr>
                                      </thead>
                                      <tbody id="myTable">
                                      
                                      @foreach ($Historiquem as $item)
                                          <tr>
                                            <td>{{$item->nom_pat}}</td>
                                            <td>{{$item->prenom_pat}}</td>
                                            <td>{{$item->etat_rendez}}</td>
                                            <td>{{$item->date_rendez}}</td>
                                          </tr>
                                      @endforeach
