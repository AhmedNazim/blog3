...
<body>
    <div id="app">
        <nav style="background-color:rgba(43, 63, 82, 0.9);" class="navbar navbar-default navbar-static-top">
            <div  class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @if (Auth::guest())
                            ...
                            <li > <a  style="color:white" class="navbar-brand"href=""> <i style="color:white" class="fas fa-stethoscope"></i>&nbsp;&nbsp;Gestion des visites médicales  </a> </li>
