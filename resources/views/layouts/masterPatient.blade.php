...
<title>CDTA | GVM</title>
    ...
    <link href="{{asset('/css/cssPfe.css')}}" rel="stylesheet">
                ...
                <ul  class="nav metismenu" id="side-menu">
                    <li  class="nav-header">
                        <div  class="dropdown profile-element"> <span>
                            <img alt="image" class="img-circle" src="/img/patient1.png" width="60" />
                             </span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"></strong>
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">{{$userPat[0]->nom_pat." ".$userPat[0]->prenom_pat  }}</strong>
                              <br>
                        ...
                        {{-- <li>
                                <a href="/gestioncoremedicale"><i class="fa fa-pie-chart"></i> <span class="nav-label">Gestion corp médicale</span>  </a>
                        </li>
                        --}}
 <!-- 
                    <li class="">
                    ...
                    {{-- <li>
                        <a href="/gestionpatient"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Gestion  patients</span><span class="fa arrow"></span></a>
                        
                    </li>
                   
                    <li>
                        <a href="/gestionrendezvous"><i class="fa fa-envelope"></i> <span class="nav-label">Gestion  rendez-vous</span></a>
                        
                    </li>
                   
                    <li>
                        <a href="metrics.html"><i class="fa fa-pie-chart"></i> <span class="nav-label">Historique des manipulations</span>  </a>
                    </li>

                    
                    <li>
                        <a href="widgets.html"><i class="fa fa-flask"></i> <span class="nav-label">Historique des rendez-vous</span></a>
                    </li>
                  
                    <li>
                            <a href="metrics.html"><i class="fa fa-pie-chart"></i> <span class="nav-label">Rechercher</span>  </a>
                    </li> --}}
...
new Vue({
    ...
    methods: {
        patientaccepte :function(matricule)
        {
            axios.get('http://127.0.0.1:8000/patientaccepte/'+matricule)
            
        },
        patientrefuse :function(matricule)
        {
            axios.get('http://127.0.0.1:8000/patientrefuse/'+matricule)
